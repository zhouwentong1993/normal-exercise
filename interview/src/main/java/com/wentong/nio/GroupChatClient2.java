...
public class GroupChatClient2 implements Closeable {
    ...
    public GroupChatClient2() throws Exception {
    ...
    public static void main(String[] args) throws Exception {
        try (GroupChatClient2 groupChatClient = new GroupChatClient2()) {
            System.out.println("客户端启动~");
            new Thread(GroupChatClient2::readInfoFromServer).start();
