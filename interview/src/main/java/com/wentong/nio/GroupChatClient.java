...
public class GroupChatClient implements Closeable {
    ...
    public static void main(String[] args) throws Exception {
        try (GroupChatClient groupChatClient = new GroupChatClient()) {
            System.out.println("客户端启动~");
            new Thread(GroupChatClient::readInfoFromServer).start();
